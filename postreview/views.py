...
def list_reviews(request):
    ...
    if query:
        queryset_list =  queryset_list.filer(Q(first_name__icontains=query) | Q(last_name__icontains=query) | Q(photograph__icontains=query) | Q(designation__icontains=query) | Q(company__icontains=query) | Q(comments__icontains=query)).distinct()
